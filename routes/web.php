...
Route::delete('/admin/delete/recipe/{id}', [AdminController::class, 'deleteRecipe'])->name('admin.recipe.delete');
Route::delete('/admin/recipes/{recipeId}/ingredients/{ingredientId}/delete', [AdminController::class, 'deleteIngredient'])->name('admin.ingredient.delete');
